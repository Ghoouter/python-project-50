...
parameter = [('path1_json', 'path2_json', 'stylish',
              'gendiff/tests/fixtures/result_stylish.txt'),
             ...
             ('path1_yaml', 'path2_yaml', 'stylish',
              'gendiff/tests/fixtures/result_stylish.txt'),
             ('path1_yaml', 'path2_yaml', 'plain',
              'gendiff/tests/fixtures/result_plain.txt'),
             ('path1_yaml', 'path2_yaml', 'json',
              'gendiff/tests/fixtures/result_json.txt')]
